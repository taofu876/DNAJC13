...
# Save files
ggsave("7_RoR_color_by_groups_V2_WTKO_mut2KO_V2.png", plot = p1, height = 8, width = 10, dpi = 300)
ggsave("7_RoR_color_by_groups_V2_WTKO_mut2KO_V2.pdf", plot = p1, height = 8, width = 10, device = "pdf", useDingbats = FALSE)
