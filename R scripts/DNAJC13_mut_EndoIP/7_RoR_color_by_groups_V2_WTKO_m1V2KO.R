...
col_y     <- "log2FC_157resmut1V2.157KO"
...
base_colors <- c("#27ae60","#c0392b", "#085990", "#8e44ad",  "#e67e22")
...
# Save files
ggsave("7_RoR_color_by_groups_V2_WTKO_m1V2KO_V2.png", plot = p1, height = 8, width = 10, dpi = 300)
ggsave("7_RoR_color_by_groups_V2_WTKO_m1V2KO_V2.pdf", plot = p1, height = 8, width = 10, device = "pdf", useDingbats = FALSE)
